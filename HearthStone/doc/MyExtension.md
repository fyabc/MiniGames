...
1. _ 中立 随从 普通 鱼人 3 2 2 - **战吼**：抽一张鱼人牌。
...
1. _ 中立 随从 普通 元素 4 4 2 - **亡语**：对一个随机敌方随从造成3点伤害。
...
1. 狂野的法师 中立 随从 史诗 6 3 5 - **战吼**：随机召唤一个不能在标准模式卡组中使用的史诗随从。
...
1. _ 潜行者 随从 普通 4 3 4 - **战吼**：每个玩家抽一张随从牌。
