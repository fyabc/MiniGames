...
1. 侏儒大师XXX 中立 随从 传说 5 3 5 - 每当有玩家使用一张史诗或传说随从时，使该随从牌变形成为1/1的小鸡。
1. “XX者”洛欧塞布 中立 随从 传说 5 5 5 - **战吼**：下个回合敌方随从的法力值消耗增加(5)点。
1. 巫妖王阿尔萨斯 中立 随从 传说 9 7 7 - **战吼**：**冻结**所有随从。若有随从已被**冻结**，则改为将其消灭。
1. _ 中立 随从 传说 龙 8 4 12 - 在你的回合结束时，将一张_置入你的手牌。
（_ 法术 0 - 造成1点伤害。本局对战中你每使用过一张该牌，造成的伤害+1。）
...
1. _ 法师 随从 史诗 5 4 3 - **战吼**：为你的对手召唤一个_。
...
1. _ 猎人 随从 史诗 5 3 5 - 在你的回合结束时，将你的护甲值变为4点。      # 加强猎人回血能力？
...
1. _ 战士 随从 史诗 4 3 3 - **战吼**：使一个友方随从获得“同时对其攻击目标相邻的随从造成伤害。”。     # 加强战士竞技场

### 潜行者

1. _ 潜行者 随从 普通 3 4 3 - **亡语**：使该随从左边的随从获得**潜行**。
1. _ 潜行者 法术 普通 3 - 选择一个友方随从，对与该随从相对的随从造成等同于该随从攻击力的伤害。

1. _ 潜行者 随从 稀有 4 3 4 - **战吼**：每个玩家抽一张随从牌。
1. _ 潜行者 随从 稀有 4 4 4 - **亡语**：将一张你在本局对战中施放的法力值消耗为(1)点的法术置入你的手牌。
1. _ 潜行者 法术 稀有 2 - **发现**一张具有**连击**的牌。**连击**：使该牌的法力值消耗减少(1)点。
1. _ 潜行者 武器 稀有 4 3 2 - 每当该武器消灭一个随从，抽一张法力值消耗等同于该随从法力值消耗的牌。
...
- **专注**：当你使用一张牌时，若该牌消耗你的所有剩余的法力值，触发该效果。 # *转自Amaz的DIY
...
1. _ 武僧 法术 基本 1 - 抽一张法力值消耗等同于你剩余的法力值的牌。
...
1. _ 武僧 随从 普通 2 2 1 - **战吼**：抽一张法力值消耗等同于你剩余的法力值的牌。
...
1. _ 武僧 随从 稀有 4 4 4 - **入手**：为你的英雄恢复4点生命值。
1. _ 武僧 随从 稀有 5 4 5 - **入手**：对所有随从造成1点伤害。

1. _ 武僧 随从 史诗 2 2 2 - **冲锋**，**入手**：将该随从（从你的手牌）置入战场。
1. _ 武僧 随从 史诗 6 3 4 - **战吼**：对所有随从造成等同于你的剩余法力值的伤害。
