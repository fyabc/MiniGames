...
1. _ 中立 随从 史诗 2 1 2 - 每当你的其他随从死亡时，将一张“烈焰元素”置入你的手牌。
...
1. 恶魔施法者 中立 随从 史诗 恶魔 7 6 7 - **专注**：恢复你的两个法力水晶。
...
1. _(香港记者?) 中立 随从 传说 7 4 6 - **突袭**，在你的回合结束时，将该随从移回你的手牌。
1. _ 中立 随从 传说 7 9 9 - 本局对战中，你的法力水晶不会自动增长；当对战开始时，将30张水晶币置入你的牌库，将2张水晶币置入你的手牌。
（水晶币 法术 衍生物 0 - 抽一张牌。在本回合中，获得一个法力水晶。）   # 应该过强
1. 亚雷戈斯 中立 随从 传说 龙 9 4 12 - **战吼**：将一张“吐息”置入你的手牌。在你的回合结束时，将一张“吐息”置入你的手牌。
...
1. 猛犸之王 中立 随从 传说 10 5 5 - **嘲讽**，**战吼**：**发现**一张**任务**牌、死亡骑士英雄牌或**传说**武器牌。
...
1. _ 德鲁伊 随从 传说 7 3 6 - 在你的对手使用一张牌后，使其剩余法力值变为(0)点。

### 法师

1. _ 法师 随从 普通 元素 6 4 5 - **战吼**：你的手牌中每有一张“烈焰元素”，便对一个随机敌方随从造成2点伤害。
...
1. _ 战士 随从 稀有 2 1 2 - **突袭**，（*使用一张具有**突袭**的随从牌后升级。*）
（_ 战士 随从 衍生物 2 3 2 - **突袭**，（*使用一张具有**突袭**的随从牌后升级。*））
...
1. _ 牧师 法术 普通 3 - 召唤一个在本局对战中死亡的法力值消耗最低的友方随从。
