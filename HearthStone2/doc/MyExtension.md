...
1. _ 中立 随从 史诗 8 5 8 - **战吼**：在本回合中，使你的**专注**牌的法力值消耗减少(5)点。
...
（吐息 法术 0 - 造成1点伤害。本局对战中，你每使用过一张“吐息”，造成的伤害+1。）
...
1. 根须缠绕 德鲁伊 法术 普通 0 - 使一个随从获得**嘲讽**和“无法攻击”。

1. _ 德鲁伊 随从 稀有 3 2 4 - 你的英雄在你的回合获得+2攻击力。
1. 丛林德鲁伊 德鲁伊 随从 稀有 6 5 6 - **嘲讽**，**战吼**：使一个随从获得**嘲讽**和“无法攻击”。
...
1. _ 法师 随从 史诗 4 2 6 - 每当你施放一个法术，对敌方英雄造成2点伤害。
1. _ 法师 随从 史诗 5 4 3 - **战吼**：为你的对手召唤一个寒冰元素。
（寒冰元素 法师 随从 元素 3 0 3 - 在你的回合开始时，随机**冻结**一个友方角色。）
...
1. _ 圣骑士 法术 史诗 1 - **任务**：使10个友方白银之手新兵死亡。**奖励**：_
（_ 圣骑士 场地 3 - 在你的回合结束时，使一个随机友方随从获得+2/+3。）
...
1. _ 牧师 随从 稀有 4 4 7 龙 - **专注**：对自身造成2点伤害。
...
1. _ 萨满 随从 普通 4 3 3 元素 - **战吼**：每有一个友方图腾，便随机**冻结**一个敌人。
...
1. _ 萨满 随从 稀有 3 3 1 - **战吼**：本回合中，使一个友方图腾获得+4攻击力。
