...
1. _ 中立 随从 普通 5 5 4 - **亡语**：恢复你的两个法力水晶。
...
1. _ 中立 随从 稀有 鱼人 1 1 1 - 在你的回合结束时，若你的法力水晶数不小于4，则获得+1/+1。
...
1. 钱币收藏家 中立 随从 传说 5 5 5 - **战吼**：若XXX，则**发现**一张钱币牌。
    > 所有钱币牌：
...
1. _ 法师 法术 普通 6 - 对一个随从和敌方英雄造成4点伤害。你在上回合中每使用过一张元素牌，造成的伤害+1。

------

1. _ 法师 随从 稀有 4 4 3 - **战吼**：揭示你的对手牌库中的一张法术牌，将其变为“冰封秘典”。
1. _ 法师 法术 普通 3 - **奥秘**：在最左边的敌方随从攻击时，将其消灭。
...
1. _ 法师 随从 传说 元素 7 7 7 - **对战开始时**：将你的英雄技能变为“元素呼唤”。
...
1. _ 圣骑士 法术 稀有 1 - **奥秘**：在你的对手的回合结束时，若其有未用完的法力水晶，则召唤一个2/2并具有**圣盾**的_。
...
1. _ 圣骑士 随从 传说 6 6 6 - **战吼**：若你的牌库中的所有随从牌都具有种族，则XXX。

### 猎人

1. _ 猎人 随从 普通 野兽 2 1 1 - **突袭**，**亡语**：**招募**一个_(self)。
...
1. 狂犬注射 猎人 法术 史诗 4 - 选择一个友方随从。该随从攻击一个随机敌方随从，重复三次。
    > 三次攻击的目标可以不一样
...
> TODO: 术士10张牌法力值分别为1 ~ 10

1. _ 术士 随从 普通 2 1 2 - **回响**，**战吼**：战场上每有一个其他_(self)，便获得+1攻击力。
1. _ 术士 随从 普通 6 6 6 - **战吼**：选择一张手牌，将其弃置。
...
1. _ 术士 随从 传说 恶魔 10 8 8 - XXX
1. _ 术士 法术 传说 1 - **任务**：使用法力值消耗为(2)~(10)的牌各一张。**奖励**：???

### 战士

1. _ 战士 随从 普通 3 1 4 - **突袭**，场上每有一个受伤的随从，便获得+1攻击力。
1. _ 战士 法术 普通 3 - 消灭最左边的敌方随从。
...
1. _ 战士 法术 史诗 2 - **任务**：使用四张法力值消耗为(4)点的牌，**奖励**：根据使用的最后一张牌的类别，获得相应奖励。
    ...
    1. _ 战士 随从 衍生物 4 6 6 - XXX   // 使用随从牌
    1. _ 战士 法术 衍生物 4 - XXX       // 使用法术牌
    1. _ 战士 武器 衍生物 4 5 2 - XXX   // 使用武器牌
    1. _ 战士 英雄 衍生物 4 - XXX       // 使用英雄牌
...
1. _ 牧师 随从 稀有 元素 3 3 3 - **战吼**：在本回合中，获得等同于你上回合未使用的法力水晶数的法力水晶。
...
1. _ 牧师 随从 传说 6 4 8 - 每当一个随从被**沉默**，复制该随从并置入你的手牌。
1. _ 牧师 法术 传说 1 - **任务**：使用来自五个不同系列的卡牌。**奖励**：_。
    > 说明：例如使用基础、标准、安戈洛、冰封王座、狗头人卡牌各一张
    > 奖励牌：
    1. _ 牧师 法术 衍生物 5 - 本局对战中，你的所有与你使用的上一张牌系列不同的牌的法力值消耗减少(2)点。
    > 奖励牌说明：
    > 若你使用的上一张牌为基础牌，则你手牌中的基础牌费用不变，其余牌法力值消耗均减少(2)点。
    > 其余类推。
...
1. 弹簧刀(?) 萨满 武器 稀有 3 2 3 - 在你的回合结束时，若该武器攻击力小于4，则获得+1攻击力，否则攻击力变为2。
...
1. 石母瑟拉塞恩 萨满 随从 传说 元素 7 8 6 - **亡语**：进入大地状态。
    1. 大地状态 萨满 特殊 衍生物 - 在你的第三个回合开始时苏醒，变为石母瑟拉塞恩。
    > 说明：“大地状态”类似于“瑟拉金之种”。
