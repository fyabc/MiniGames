...
1. _ 中立 随从 普通 8 6 6 - **战吼**：随机复活一个在本回合中死亡的法力值消耗不大于(4)点的友方随从。
...
1. _ 德鲁伊 法术 普通 1 - 将三个小精灵置入你的手牌，将三个小精灵洗入你的牌库。
...
1. _ 法师 随从 传说 元素 3 3 4 - **对战开始时**：将你的英雄技能变为“元素呼唤”。
...
1. _ 萨满 法术 史诗 10 - 召唤所有本局对战中你召唤过的攻击力比生命值至少大(3)的随从。
    > 过强？
