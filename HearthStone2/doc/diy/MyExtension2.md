...
1. _ 圣骑士 随从 稀有 5 4 5 - **战吼**：使该随从左边的随从获得+2攻击力，右边的随从获得+2生命值。
...
1. _ 术士 随从 普通 4 4 2 - **战吼**：选择一张手牌，将其弃置。
...
1. _ 牧师 随从 普通 4 2 4 - **战吼**：本回合中，你施放的下一张法术牌的效果会触发两次。
    > 对相同目标或随机选择目标？
1. _ 牧师 法术 普通 2 - **沉默**一个随从，然后使其获得“**亡语**：对所有随从造成1点伤害。”

------

1. _ 牧师 随从 稀有 3 3 3 - **战吼**：在本回合中，获得等同于你上回合未使用的法力水晶数的法力水晶。
1. _ 牧师 随从 稀有 6 4 8 - 每当一个随从被**沉默**，复制该随从并置入你的手牌。
