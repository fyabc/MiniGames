...
1. _ 中立 随从 稀有 3 2 3 - **专注**：在你的下回合开始时，对所有角色造成2点伤害。
...
1. _ 中立 随从 稀有 5 5 5 - **专注**：使你的武器获得+1耐久度。
...
1. _ 中立 随从 史诗 4 3 5 - 你的**专注**效果会触发两次。
...
1. 树人施法者 德鲁伊 随从 普通 4 3 4 - **专注**：将一张“愤怒”置入你的手牌。
