...
1. _ 中立 随从 普通 2 2 2 - **战吼**：揭示你的牌库中的一张法术牌，使其法力值消耗减少(1)点。
...
1. _ 中立 随从 普通 5 6 4 - **战吼**：揭示双方牌库里的一张法术牌。如果你的法术牌法力值消耗较大，将一个幸运币置入你的手牌。
...
1. _ 中立 随从 史诗 6 6 4 - **战吼**：若你控制至少一个**任务**，则对一个随从造成4点伤害。
...
1. _ 猎人 随从 稀有 8 6 6 - **战吼**：对所有敌方随从造成2点伤害。当你揭示该牌时，触发其战吼效果。
...
1. _ 萨满 法术 稀有 5 - 随机召唤一个法力值消耗为(5)点的随从。当你揭示这张牌时，随机召唤一个法力值消耗为(3)点的随从。
