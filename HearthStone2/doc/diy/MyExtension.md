...
1. _ 中立 随从 普通 3 2 2 - **亡语**：**招募**一个_(self)。
...
1. 独眼土狼 中立 随从 稀有 野兽 4 1 4 - 每当该随从左边相邻的随从死亡时，该随从获得其攻击力。
1. 魔暴龙宝宝 中立 随从 稀有 野兽 4 2 2 - **冲锋**，**战吼**：在本回合中，你每抽过一张牌，便获得+1攻击力。
1. _ 中立 随从 稀有 4 5 4 - **战吼**：揭示你的对手的两张手牌。
...
（说明：法力值相同的牌顺序随机）
1. “XX者”布莱恩 中立 随从 传说 3 2 4 - 当你召唤一个随从时，触发其**激励**效果。
...
1. _ 德鲁伊 法术 史诗 10 - 在本回合结束后，进行一个额外的回合。  // *设计于安戈洛之前
...
1. 烈焰药水 法师 法术 稀有 4 - 造成3点伤害，将一张“烈焰喷涌”置入你的手牌。    // 药水牌
...
1. 狂热药水 术士 法术 稀有 0 - 摧毁你的一个法力水晶，然后仅在本回合中，获得三个法力水晶。  // 药水牌
...
1. 净化药水 牧师 法术 史诗 5 - **沉默**所有敌方随从，然后对所有敌方随从造成2点伤害。 // 药水牌
